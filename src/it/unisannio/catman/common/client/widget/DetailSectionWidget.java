...
public class DetailSectionWidget extends Composite implements HasWidgets{

	private static DetailSectionWidgetUiBinder uiBinder = GWT.create(DetailSectionWidgetUiBinder.class);

	interface DetailSectionWidgetUiBinder extends UiBinder<Widget, DetailSectionWidget> {}

	@UiField protected Label titleLabel;
	@UiField protected VerticalPanel contentPanel;
	
	
	public @UiConstructor DetailSectionWidget(String title){
		this(title, (Widget[]) null);
	}
	
	public DetailSectionWidget(String title, Widget... widgets){
