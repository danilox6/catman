...
public class MasterActivity extends ScreenActivity implements Seller.Master {

	@Override
	public void start(AcceptsOneWidget panel, EventBus eventBus) {
		final Seller.Master.View masterView = new MasterView();
		...
		try{
			...
			dataStore.sellers().find(entityId).fire(new Receiver<SellerProxy>() {
				...
				public void onSuccess(final SellerProxy seller) {
					masterView.setSellerProxy(seller);
					...
					masterView.setOfferProxyQuery(query);
				}
